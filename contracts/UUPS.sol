...
contract Proxy {
    ...
    constructor(address implementation) {
        ...
        bytes memory initialize = abi.encode(bytes4(keccak256("initialize()"))); // Call initialize function on logic contract
        (bool success, bytes memory result ) = implementation.delegatecall(initialize); // solium-disable-line
